...
Projects that have questions about foundations are welcome to contact [CORSA](https://corsa.center) by emailing one of the members of its leadership team. And those with questions that are specific to [NumFOCUS](https://numfocus.org) should use the contact link on its website.
